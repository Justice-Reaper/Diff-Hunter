...
public final class Constants {
    ...
    public static final String EXTENSION_VERSION = "1.2";
    ...
    public static final int DEFAULT_MAX_LOG_ENTRIES = 10000;
    public static final int MIN_LOG_ENTRIES = 100;
    public static final int MAX_LOG_ENTRIES = 100000;
    ...
    public static final String[] MATCH_TABLE_COLUMNS = {"Difference", "Show"};
}
